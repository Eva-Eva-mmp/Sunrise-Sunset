...
try {
    ...
    // $sql = "SELECT DATE(created_at) AS datum, MIN(sunrise) AS sonnenaufgang, MIN(sunset) AS sonnenuntergang FROM sunriseandsunset GROUP BY DATE(timestamp)";
    $sql = "SELECT * FROM sunriseandsunset ORDER BY date ASC";
